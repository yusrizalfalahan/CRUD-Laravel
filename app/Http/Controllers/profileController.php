...
class profileController extends Controller
{
    ...
    function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Foto yang dimasukan hanya diperbolehkan berkestensi JPEG, JPG, PNG, dan GIF ',
        ...
        if ($request->hasFile('_foto')) {
            ...
            return redirect()->route('profile.index')->with('success', 'Behasil update data profile');
    }
}
